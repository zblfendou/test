...
@ImportResource({"classpath*:school-dubbo.xml"})
@ComponentScan("com.dubbotest.service")
@EnableJpaRepositories("com.dubbotest.service.repositories")
@EntityScan("com.dubbotest.service.**.models")
